        ...
        <div >
            <div>
                <h1 style={{ display: 'flex', position: 'relative', fontSize: '50px', alignItems: 'center', justifyContent: 'center', marginBottom: '70px'}}>
                    <img src={langicon} alt='language icon' style={{ height: '50px', width: '60px', paddingRight: '20px'}} />LANGUAGES</h1>
            </div>

            <div className='languages-container' style={{ display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                 <img src={react} alt='react' className='image' style={{
                    height: '90px',
                    width: '280px',
                    padding: '20px'
                }} />
                <img src={html} alt='html' className='image' style={{
                    height: '250px',
                    width: '180px',
                    padding: '20px'
                }} />
                ...
                <img src={java} alt='java' className='image' style={{
                    height: '230px',
                    width: '180px',
                    padding: '20px'
                }} />
                <img src={postgresql} alt='postgresql' className='image' style={{
                    height: '250px',
                    width: '210px',
                    padding: '20px'
                }} />
                <img src={jquery} alt='jquery' className='image' style={{
                    height: '80px',
                    width: '350px',
                    padding: '20px'
                }} />
